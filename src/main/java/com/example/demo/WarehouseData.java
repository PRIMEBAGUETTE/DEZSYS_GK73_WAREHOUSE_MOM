...
public class WarehouseData {
    ...
    private List<ItemData> productData = new ArrayList<>();
    ...
    public List<ItemData> getProductData() { return productData; }
    public void setProductData(List<ItemData> productData) { this.productData = productData; }
